...
{
    #### change your id
    private const CLIENT_ID = '1657673888';
    private const CLIENT_SECRET = 'f1fa2f2d124ef28c06db5a6bde75ba2d';
    private const REDIRECT_URL = 'http://localhost/0-js-project/line-login/callback.php';
